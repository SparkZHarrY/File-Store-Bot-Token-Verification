...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002189503507"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002239137626"))
...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7393899389:AAFazyqSaEB_dFMOIAeKbUtCWhX3yEqEI4E") 
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002172470237"))
#your database channel link
CHANNEL_LINK = os.environ.get("CHANNEL_LINK", "https://t.me/+xC8MEjPYrYU4MTg1")
#your id of telegram can be found by https://t.me/MissRose_bot with '/id' command
OWNER_ID = int(os.environ.get("OWNER_ID", "847244116"))
#port set to default 8080
PORT = os.environ.get("PORT", "8080")
#your database url mongodb only You can use mongo atlas free cloud database
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Newx:IVzYe5ruRuZgNVtn@cluster0.0pz61tn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
#your database name
DB_NAME = os.environ.get("DB_NAME", "pixelpirates")
...
OWNER_TAG = os.environ.get("OWNER_TAG", "Joyboy")
#Time in seconds for message delete
TIME = int(os.environ.get("TIME", "60"))


# add premium logs channel id
PAYMENT_LOGS = int(environ.get('PAYMENT_LOGS', '-1002152829792'))
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "23EgfJCbHSYQmsrl8tm0VIqXU0H2")
#add your custom time in secs for shortlink expiration.
# 24hr = 86400
# 12hr = 43200
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', "86400")) # Add time in seconds
#Tutorial video for the user of your shortner on how to download.
TUT_VID = os.environ.get("TUT_VID","https://t.me/links_tutorials_x/4")
