...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text=f"<b>» ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/linkz_3x>Toxic</a>\n» ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/+rvKyFDXfCGY1Mzc1</a>\n»</b>",
